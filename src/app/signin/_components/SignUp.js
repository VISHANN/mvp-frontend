...
export default function SignUp() {
  ...
  return (
    <section>
      <h1 className="h2" style={{ marginBottom: ".5rem" }}>
        One Last Step
      </h1>
      <h2 className="h4" style={{ marginBottom: "2rem" }}>
        Choose a username that whispers your story.
      </h2>
      ...
      <label
        htmlFor="username"
        style={{ color: isUsernameValid ? "var(--secondary-green)" : "red" }}
      >
        {isUsernameValid
